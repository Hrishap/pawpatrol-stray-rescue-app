-- Dev seed data: shelters + adoptable animals only (no dependency on real
-- auth users). Cases/notifications/chat are created by using the app after
-- signing up. Coordinates are real Kochi, Kerala locations.
